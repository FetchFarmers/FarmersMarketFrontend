...
// function ReviewForm({ productId, token, setToken }) {
...
//     const reviews = await getAllReviewsByProductId(product);
//     setReviews(reviews);
//   }
...
//     try {
//       const review = await createReview(product, { title, details, starRating }, token);
//       fetchReviews();
...
//         <h2>Reviews:</h2>
//         <ReviewsList reviews={reviews} token={token} setToken={setToken} />
//       </div>
//     </div>
//   );
// }
